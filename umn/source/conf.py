...
otcdocs_repo_name = 'opentelekomcloud-docs/customer-service-management-portal'
# Those variables are required for edit/bug links

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/customer-service-management-portal/umn/'
otcdocs_doc_title = 'User Guide'
otcdocs_doc_type = 'umn'
otcdocs_service_category = 'other'
otcdocs_service_title = 'Customer Service Management Portal'
otcdocs_service_type = 'csmp'
...
html_title = "Customer Service Management Portal - User Guide"
...
latex_documents = [
    ('index',
     'csmp-umn.tex',
    u'Customer Service Management Portal - User Guide',
